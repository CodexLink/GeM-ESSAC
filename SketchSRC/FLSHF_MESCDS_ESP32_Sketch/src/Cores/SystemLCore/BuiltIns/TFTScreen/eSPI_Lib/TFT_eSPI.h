...
#if defined (ESP32)
  #include "Processor/TFT_eSPI_ESP32.h"
#elif defined (ESP8266)
  #include "Processor/TFT_eSPI_ESP8266.h"
#elif defined (STM32)
  #include "Processor/TFT_eSPI_STM32.h"
#else
  #include "Processor/TFT_eSPI_Generic.h"
#endif
