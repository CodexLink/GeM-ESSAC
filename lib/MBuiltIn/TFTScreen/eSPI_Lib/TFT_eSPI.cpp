...
#if defined (ESP32)
  #include "Processor/TFT_eSPI_ESP32.c"
#elif defined (ESP8266)
  #include "Processor/TFT_eSPI_ESP8266.c"
#elif defined (STM32) // (_VARIANT_ARDUINO_STM32_) stm32_def.h
  #include "Processor/TFT_eSPI_STM32.c"
#else
  #include "Processor/TFT_eSPI_Generic.c"
#endif
...
void TFT_eSPI::init(uint8_t tc)
{
  ...
  // This loads the driver specific initialisation code  <<<<<<<<<<<<<<<<<<<<< ADD NEW DRIVERS TO THE LIST HERE <<<<<<<<<<<<<<<<<<<<<<<
    ...
    #include "Driver/ILI9341_Init.h"

#elif defined (ST7735_DRIVER)
    tabcolor = tc;
    #include "Driver/ST7735_Init.h"

#elif defined (ILI9163_DRIVER)
    #include "Driver/ILI9163_Init.h"

#elif defined (S6D02A1_DRIVER)
    #include "Driver/S6D02A1_Init.h"

#elif defined (ST7796_DRIVER)
    #include "Driver/ST7796_Init.h"

#elif defined (ILI9486_DRIVER)
    #include "Driver/ILI9486_Init.h"

#elif defined (ILI9481_DRIVER)
    #include "Driver/ILI9481_Init.h"

#elif defined (ILI9488_DRIVER)
    #include "Driver/ILI9488_Init.h"

#elif defined (HX8357D_DRIVER)
    #include "Driver/HX8357D_Init.h"

#elif defined (ST7789_DRIVER)
    #include "Driver/ST7789_Init.h"

#elif defined (R61581_DRIVER)
    #include "Driver/R61581_Init.h"

#elif defined (RM68140_DRIVER)
	#include "Driver/RM68140_Init.h"

#elif defined (ST7789_2_DRIVER)
    #include "Driver/ST7789_2_Init.h"

#elif defined (SSD1963_DRIVER)
    #include "Driver/SSD1963_Init.h"

#elif defined (GC9A01_DRIVER)
     #include "Driver/GC9A01_Init.h"
...
#if   defined (ILI9341_DRIVER)
    #include "Driver/ILI9341_Rotation.h"

#elif defined (ST7735_DRIVER)
    #include "Driver/ST7735_Rotation.h"

#elif defined (ILI9163_DRIVER)
    #include "Driver/ILI9163_Rotation.h"

#elif defined (S6D02A1_DRIVER)
    #include "Driver/S6D02A1_Rotation.h"

#elif defined (ST7796_DRIVER)
    #include "Driver/ST7796_Rotation.h"

#elif defined (ILI9486_DRIVER)
    #include "Driver/ILI9486_Rotation.h"

#elif defined (ILI9481_DRIVER)
    #include "Driver/ILI9481_Rotation.h"

#elif defined (ILI9488_DRIVER)
    #include "Driver/ILI9488_Rotation.h"

#elif defined (HX8357D_DRIVER)
    #include "Driver/HX8357D_Rotation.h"

#elif defined (ST7789_DRIVER)
    #include "Driver/ST7789_Rotation.h"

#elif defined (R61581_DRIVER)
    #include "Driver/R61581_Rotation.h"

#elif defined (RM68140_DRIVER)
	#include "Driver/RM68140_Rotation.h"

#elif defined (ST7789_2_DRIVER)
    #include "Driver/ST7789_2_Rotation.h"

#elif defined (SSD1963_DRIVER)
    #include "Driver/SSD1963_Rotation.h"

#elif defined (GC9A01_DRIVER)
     #include "Driver/GC9A01_Rotation.h"
